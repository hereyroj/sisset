...
function obtenerRegistros() {
    $.ajax({
        ...
        type: "GET",
        url: '/admin/sistema/parametros/pqr/obtenerRegistros',
        dataType: 'html',
...
function nuevoRegistro() {
    $.confirm({
        ...
        content: 'url:/admin/sistema/parametros/pqr/nuevoRegistro',
            ...
            registrar: {
                ...
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/parametros/pqr/crearRegistro',
                            dataType: 'html',
                            method: 'post',
                            async: false,
                            cache: false,
...
function editarRegistro(id) {
    $.confirm({
        ...
        content: 'url:/admin/sistema/parametros/pqr/editarRegistro/' + id,
            ...
            actualizar: {
                ...
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/parametros/pqr/guardarCambios',
                            dataType: 'html',
                            method: 'post',
                            async: false,
                            cache: false,
...
function filtrarRegistros() {
    $.ajax({
        ...
        type: "POST",
        url: '/admin/sistema/parametros/pqr/filtrarRegistros',
        dataType: 'html',
        data: {
