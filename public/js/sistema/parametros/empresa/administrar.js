...
function obtenerRegistros() {
    $.ajax({
        ...
        type: "GET",
        url: '/admin/sistema/parametros/empresa/obtenerRegistros',
        dataType: 'html',
...
function nuevoRegistro() {
    $.confirm({
        ...
        content: 'url:/admin/sistema/parametros/empresa/nuevoRegistro',
            ...
            registrar: {
                ...
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/parametros/empresa/crearRegistro',
                            dataType: 'html',
                            method: 'post',
                            async: false,
                            cache: false,
...
function editarRegistro(id) {
    $.confirm({
        ...
        content: 'url:/admin/sistema/parametros/empresa/editarRegistro/' + id,
            ...
            actualizar: {
                ...
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/parametros/empresa/guardarCambios',
                            dataType: 'html',
                            method: 'post',
                            async: false,
                            cache: false,
...
function filtrarRegistros() {
    $.ajax({
        ...
        type: "POST",
        url: '/admin/sistema/parametros/empresa/filtrarRegistros',
        dataType: 'html',
        data: {
