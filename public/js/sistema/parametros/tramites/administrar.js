...
function obtenerRegistros() {
    $.ajax({
        ...
        type: "GET",
        url: '/admin/sistema/parametros/tramites/obtenerRegistros',
        dataType: 'html',
...
function nuevoRegistro() {
    $.confirm({
        ...
        content: 'url:/admin/sistema/parametros/tramites/nuevoRegistro',
            ...
            registrar: {
                ...
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/parametros/tramites/crearRegistro',
                            dataType: 'html',
                            method: 'post',
                            async: false,
                            cache: false,
...
function editarRegistro(id) {
    $.confirm({
        ...
        content: 'url:/admin/sistema/parametros/tramites/editarRegistro/' + id,
            ...
            actualizar: {
                ...
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/parametros/tramites/guardarCambios',
                            dataType: 'html',
                            method: 'post',
                            async: false,
                            cache: false,
...
function filtrarRegistros() {
    $.ajax({
        ...
        type: "POST",
        url: '/admin/sistema/parametros/tramites/filtrarRegistros',
        dataType: 'html',
        data: {
