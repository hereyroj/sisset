...
function obtenerEmpresas() {
    $.ajax({
            ...
            type: "GET",
            url: '/admin/sistema/empresasMensajeria/obtenerEmpresas',
        }).done(function (data) {
...
function editarEmpresa(id) {
    $.confirm({
        ...
        content: 'url:/admin/sistema/empresasMensajeria/editar/' + id,
        buttons: {
            actualizar: {
                text: 'Actualizar',
                btnClass: 'btn-blue',
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/empresasMensajeria/editar',
                            dataType: 'html',
                            method: 'post',
...
function nuevaEmpresa() {
    $.confirm({
        title: 'Nueva empresa',
        content: 'url:/admin/sistema/empresasMensajeria/nueva',
        buttons: {
            crear: {
                text: 'Crear',
                btnClass: 'btn-blue',
                action: function () {
                    ...
                    if (frm.parsley().validate()) {
                        var self = this;
                        $.ajax({
                            url: '/admin/sistema/empresasMensajeria/crear',
                            dataType: 'html',
                            method: 'post',
                            data: this.$content.find('form').serialize(),
                            headers: {
