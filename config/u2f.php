...
return [
    ...
    'register' => [
         ...
         */
        'view' => 'admin.account.registerU2f',

        /*
         * the route to redirect after a successful key registration (default /)
         */
        'postSuccessRedirectRoute' => 'admin.cuenta.perfil',
    ...
    'authenticate' => [
         ...
         */
        'view' => 'admin.account.authenticationU2f',

        /*
         * the route to redirect after a successful key authentication (default /)
         */
        'postSuccessRedirectRoute' => 'admin.dashboard',
    ],
