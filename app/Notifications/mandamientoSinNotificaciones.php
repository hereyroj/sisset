...
class mandamientoSinNotificaciones extends Notification
{
    use Queueable;
    public $mandamiento;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line('El mandamiento de pago número '.$this->mandamiento->consecutivo.' hasta la fecha no cuenta con registro alguno de notificaciones.')
