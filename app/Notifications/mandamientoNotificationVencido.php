...
class mandamientoNotificationVencido extends Notification
{
    use Queueable;
    public $notificacion;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line('La notificación número '.$this->notificacion->consecutivo.' del mandamiento de pago número '.$this->notificacion->hasMandamientoPago->consecutivo.' está vencida sin que se haya aún registrado información de entrega o devolución.')
