...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\autorizeEloquentSave::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'necesitaRoles' => \App\Http\Middleware\necesitaRoles::class,
        'necesitaPermisos' => \App\Http\Middleware\necesitaPermisos::class,
        '2fa' => \App\Http\Middleware\Google2FAMiddleware::class,
        'checkLockedUser' => \App\Http\Middleware\checkLockedUser::class,
