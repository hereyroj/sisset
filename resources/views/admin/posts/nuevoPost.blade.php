    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" id="frmNuevaPublicacion" method="POST" action="{{url('admin/posts/nuevaPublicacion')}}">
                        {{ csrf_field() }}
                        <div class="row" style="margin-bottom: 1em;">
                            ...
                            <div class="group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="fecha_publicacion" id="fecha_publicacion" value="{{old('fecha_publicacion')}}">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 1em;">
                            <div class="group col-lg-4">
                                <label class="control-label">Categoría</label> {{Form::select('categoria', $categorias, old('categoria'), ['class'=>'form-control',
                                'id'=>'categoria', 'required'])}}
                            </div>
                            <div class="group col-lg-4">
                                <label class="control-label">Estado</label> {{Form::select('estado', $estados, old('estado'), ['class'=>'form-control',
                                'id'=>'estado', 'required'])}}
                            </div>
                            <div class="group col-lg-4">
                                <label class="control-label">Fecha despublicación</label>
                                <input type="text" class="form-control" name="fecha_despublicacion" id="fecha_despublicacion" value="{{old('fecha_despublicacion')}}">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 1em;">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" id="galeria" class="form-control" name="galeria" value="{{old('galeria')}}">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 1em;">
                            <div class="form-group col-lg-12">
                                <label class="control-label">Extracto</label>
                                <textarea id="extracto" class="form-control" name="extracto">{{old('extracto')}}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label class="control-label">Etiquetas</label>
                                <input type="text" id="etiquetas" class="form-control" name="etiquetas" value="{{old('etiquetas')}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12">
...
<script type="text/javascript" src="{{asset('js/posts/nuevoPost.js')}}"></script>
@if(old('post_data') != null)
<script type="text/javascript">
    setOld("{{old('post_data')}}");
</script>
@endif
@endsection