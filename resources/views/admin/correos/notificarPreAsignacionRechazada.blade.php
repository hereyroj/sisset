                                                                            ...
                                                                            <div style="color:#555555;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                                                    <p style="margin: 0;font-size: 12px;line-height: 14px">
                                                                                        ...
                                                                                        solicitud de pre-asignación al
                                                                                        vehículo con Número de motor
                                                                                        &nbsp;{{$solicitud->numero_motor}}
                                                                                        y Número de chasis
                                                                                        &nbsp;{{$solicitud->numero_chasis}}
                                                                                        , ha
                                                                                        sido rechazada lo siguiente:
                                                                                        <br>
                                                                                        <strong>Motivo:</strong> {{$solicitud->fueRechazada()->name}}
                                                                                        <br> <strong>Observación del
                                                                                            funcionario:</strong> {{$solicitud->fueRechazada()->pivot->observacion}}
                                                                                    </p>
                                                                                    <p style="margin: 0;font-size: 12px;line-height: 14px">
                                                                                        &nbsp;<br>
                                                                                    </p>
