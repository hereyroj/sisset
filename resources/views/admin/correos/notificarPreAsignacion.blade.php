                                                                            ...
                                                                            <div style="color:#555555;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                                                    <p style="margin: 0;font-size: 12px;line-height: 14px">
                                                                                        ...
                                                                                        finalidad de informarle que su
                                                                                        solicitud de pre-asignación
                                                                                        al vehículo con Número de motor
                                                                                        &nbsp;{{$sp->numero_motor}} y
                                                                                        Número de chasis
                                                                                        &nbsp;{{$sp->numero_chasis}}, ha
                                                                                        sido aceptada y se le ha
                                                                                        pre-asignado la placa
                                                                                        &nbsp;{{$ev->name}}.<br>
                                                                                        Recuerde que esta pre-asignación
                                                                                        será válida durante los
                                                                                        siguiente sesenta (60) días. Si
                                                                                        transcurrido ese tiempo
                                                                                        no se realiza la matricula del
                                                                                        vehículo, la pre-asignación sera
                                                                                        anulada.
                                                                                    </p>
                                                                                    <p style="margin: 0;font-size: 12px;line-height: 14px">
                                                                                        &nbsp;<br></p></div>
