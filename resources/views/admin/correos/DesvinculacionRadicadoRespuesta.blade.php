                                                                            ...
                                                                            <div style="color:#555555;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                                                    <p style="margin: 0;font-size: 12px;line-height: 14px">
                                                                                        ...
                                                                                        darle a conocer que por error se asigno por respuesta a su proceso PQR con radicado de entrada
                                                                                        {{$pqr->getRadicadoEntrada->numero}}, el proceso PQR
                                                                                        con radicado de salida {{$radicadoAnterior}}.<br><br>
                                                                                    Se ha desvinculado el proceso mencionado. Lamentamos el inconveniente.</p>
                                                                                    <p style="margin: 0;font-size: 12px;line-height: 14px">
                                                                                        &nbsp;<br></p></div>
                                                                            </div>
                                                                        </td>
