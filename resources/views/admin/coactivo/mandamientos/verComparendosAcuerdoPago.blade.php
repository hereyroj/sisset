@foreach($comparendos as $comparendo)
    <div class="row" style="margin:0; border-bottom: 2px solid black; margin-bottom: 20px;">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            @if($comparendo->hasPago != null)
                <p>Modalidad de pago: {{$comparendo->hasPago->hasModalidad->name}}</p>
                <p>Número de cuotas: {{$comparendo->hasPago->cuotas}}</p>
                <p>Valor cuota: {{$comparendo->hasPago->valor_cuota}}</p>
                <p>Descuento %: {{$comparendo->hasPago->descuento}}</p>
            @else
