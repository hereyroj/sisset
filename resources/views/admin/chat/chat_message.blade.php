    ...
    <div class="received_msg">
        <div class="received_withd_msg">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><i class="fas fa-file"></i> {{$file->original_name}} <a target="_blank" href="{{url('admin/chat/downloadFile/'.$file->uuid)}}" class="chat_download_button"><i class="fas fa-arrow-circle-down"></i></a></li>
                @endforeach
            </ul>
            @endif
