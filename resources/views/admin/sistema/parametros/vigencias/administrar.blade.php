...
<title>Administrar vigencias</title>
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Administrar vigencias</div>
               <div class="card-body">
...
@section('scripts')
<script type="text/javascript" src="{{asset('js/sistema/parametros/vigencias/administrar.js')}}"></script>
@endsection