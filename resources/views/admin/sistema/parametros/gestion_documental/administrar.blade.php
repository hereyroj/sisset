...
<title>Parámetros de Gestión Documental</title>
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Parámetros de Gestión Documental</div>
               <div class="card-body">
...
@section('scripts')
<script type="text/javascript" src="{{asset('js/sistema/parametros/gestion_documental/administrar.js')}}"></script>
@endsection