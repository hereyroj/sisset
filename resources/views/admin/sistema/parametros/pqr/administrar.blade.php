...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Parámetros de PQR</div>
               <div class="card-body">
...
@section('scripts')
<script type="text/javascript" src="{{asset('js/sistema/parametros/pqr/administrar.js')}}"></script>
@endsection