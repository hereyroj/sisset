               ...
               <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="reportes" class="tab-pane fade" role="tabpanel">
                            <iframe id="VehiculosPorEmpresaTransporte" src="{{ url('admin/reportes/empresasTransporte/VehiculosPorEmpresaTransporte') }}"
                                height="100%" width="100%" style="height:500px; width:100%; border:none;"></iframe>
                            <iframe id="TarjetasOperacionActivasPorEmpresa" src="{{ url('admin/reportes/empresasTransporte/TarjetasOperacionActivasPorEmpresa') }}"
                                height="100%" width="100%" style="height:500px; width:100%; border:none;"></iframe>
                        </div>
                    </div>
                </div>
...
@section('scripts')
<script type="text/javascript" src="{{asset('js/sistema/empresa_transporte/administrar.js')}}"></script>
@endsection